...
<head>
  ...
  <?php if($vd["OverviewMapData"] != null) { ?>
    <script src="http://maps.googleapis.com/maps/api/js?key=<?php print GOOGLE_MAPS_API_KEY; ?>&amp;sensor=false&amp;language=<?php print Session::GetLanguageCode(); ?>" type="text/javascript"></script>
